    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white py-3 fw-semibold">Novo profissional</div>
                <div class="card-body">
                    <form method="post" class="needs-validation" novalidate>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="invalid-feedback">Informe a data de início do contrato.</div>
                        </div>
                        <div class="mt-3">
        ...
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white py-3 fw-semibold">Profissionais cadastrados</div>
                        ...
                        <?php else: ?>
                            <?php foreach ($professionals as $professional): ?>
                                <tr>
                                    ...
                                    <td><?= (new DateTime($professional['entry_date']))->format('d/m/Y') ?></td>
